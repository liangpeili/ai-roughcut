...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--profile", default="default", help="Editing profile name.")
    parser.add_argument("--ai", action="store_true", help="Call an OpenAI-compatible chat API for delete/compress/keep/review decisions.")
    parser.add_argument("--subtitle", action="store_true", help="Run WhisperX again after rough cut and generate SRT/ASS subtitles.")
    parser.add_argument("--no-render", action="store_true", help="Only generate candidates, AI task/result, cut list, and review report.")
